...
<header class="jumbotron subhead" id="overview">
 ...
 <div id="myGroup">
             ...
             <button class="btn btn-primary" data-toggle="collapse" data-target="#organizer" data-parent="#myGroup"><i class="icon-chevron-right"></i> <strong>Organizer</strong></button>
